    ...
    return (
        <section className="auth-form">
            <header className="flex flex-col gap-5 md:gap-8">
                ...
                <div className="flex flex-col pag-1 md:gap-3">
                        ...
                        <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-8'>
                            {type === 'sign-up' && (
                                <>
                                    ...
                                    <div className="flex gap-4">
                                        <CustomInput control={form.control} name='state' label='State' placeholder='Example: QLD' />
                                        <CustomInput control={form.control} name='postalCode' label='Postal Code' placeholder='Example: 4000' />
                                    </div>
                                    <div className="flex gap-4">
